...
public abstract class GameObject {
	...
	public enum ObjectType {
		...
		Truck,
		/** An ingredient to be dragged to the assemble table */
		Ingredient,
		/** An recipe to be fulfilled */
		Recipe,
		Appliance,
		Enemy,
		Food,
...
//					position.x, position.y, 0.0f, 1.0f, 1.f);
		canvas.draw(animator, Color.WHITE, origin.x, origin.y, position.x, position.y, width, height);
	}
